...
{
    public partial class FrmRasterRenderer : System.Windows.Forms.Form
    {
        ...
        public FrmRasterRenderer(AxMapControl map, AxTOCControl toc, IRasterLayer rasLayer)
        { 
            InitializeComponent();
            DrawColorRamp();
        ...
        private void DrawColorRamp()
        {
            ...
            string strDefaultStyleFileName = string.Format("{0}\\style\\ESRI.ServerStyle", Application.StartupPath);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (xtraRenderer.SelectedTabPageIndex==0)
            {
                try
                {
