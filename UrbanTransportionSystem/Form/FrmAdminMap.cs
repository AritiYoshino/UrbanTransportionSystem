...
namespace UrbanTransportionSystem
{
    ...
    public partial class FrmAdminMap : Form
    {
        ...
        private void btnExitEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            menuEdit1.Visible = false;
            btnEditCanUse(true);
        }

        private void btnBeaginToEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
